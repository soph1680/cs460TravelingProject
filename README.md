...
### Files
- project.py — TravelGraph class and Dijkstra algorithm
- main.py — graph data with all California city edges
- testCases.py — automated test suite with 3 test cases
